...
Se puede observar de la tabla anterior que el rango de las ordenadas tanto  como de las pendientes es bastante acotado, con lo cual las `r K` regresiones van a ser bastante similares:
